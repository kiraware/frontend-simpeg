            ...
            <div class="pt-5 max-h-[86vh] overflow-y-auto">
                <form @submit.prevent="handleSubmit">
                    <div class="divide-y divide-white space-y-4 px-4">
                        ...
                        <span class="text-gray-500 text-xs italic mt-1 ml-1">NPSN harus terdiri dari 8 angka</span>
                        <div class="relative">
...
export default {
    ...
    setup(_, { emit }) {
        ...
        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('createSchools', {
                    nama: nama.value,
                    npsn: npsn.value,
        ...
        return { nama, npsn, jenjang, kecamatan, districts, kelurahan, villages, alamat, loading, errorMessage, fetchRegencies, fetchRegencies, fetchVillages, handleSubmit, closeModal, errorMessage };
    },
}
</script>
