            ...
            <div class="pt-5 max-h-[86vh] overflow-y-auto">
                <form @submit.prevent="handleSubmit">
                    <div class="divide-y divide-white space-y-4">
                        <div class="relative">
                            <input type="text" id="nilai_kerja" v-model="nilai_kerja" required placeholder=" "
                        ...
                        <span class="text-gray-500 text-xs italic mt-1 ml-1">Skala penilaian 0-100</span>
                        ...
                        <div class="relative">
                            <input type="text" id="tahun" v-model="tahun" required placeholder=" " pattern="[0-9]{4}"
                            class="block px-2.5 pb-2 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                            <label for="tahun"
...
export default {
    ...
    const handleSubmit = async () => {
      try {
        loading.value = true;
        await store.dispatch('createPerformances', { 
    ...
    return { nilai_kerja, predikat, tahun, file, loading, handleSubmit, handleFileSelect, closeModal, errorMessage};
  },
}
</script>
