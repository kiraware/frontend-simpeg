                    ...
                    <div class="divide-y divide-white space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md"
                                :class="{ 'bg-blue-100': achievementData.file_url }">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="file-upload"
                                            ...
                                            <span class="">{{ file ? file.name : achievementData.file_url ?
                achievementData.file_url.split('/').pop() : 'Pilih Dokumen Sertifikat untuk diunggah' }}</span>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        nama.value = props.achievementData.nama;
        tingkat.value = props.achievementData.tingkat;
        tahun.value = props.achievementData.tahun;
        penyelenggara.value = props.achievementData.penyelenggara;
        file.value = null;
        ...
        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('updateAchievements', {
                    id: props.id,
                    nama: nama.value,
        ...
        return { nama, tingkat, tahun, penyelenggara, file, loading, handleSubmit, handleFileSelect, closeModal, errorMessage};
    },
}
</script>
