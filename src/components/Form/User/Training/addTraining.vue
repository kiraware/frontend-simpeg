    ...
    <div
        ...
        <div
            ...
            <h1 class="font-bold text-2xl text-center">
                Tambah Pendidikan dan Pelatihan
            </h1>
            ...
            <div class="pt-5">
                <form @submit.prevent="handleSubmit">
                    <div class="divide-y divide-white space-y-4">
                        ...
                        <div class="relative">
                            <input type="text" id="tahun_kegiatan" v-model="tahun_kegiatan" required pattern="[0-9]{4}"
                                class="block px-2.5 pb-2 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " />
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="file-upload"
                                            ...
                                            <span class="">{{ file ? file.name : 'Pilih Dokumen Pelatihan untuk diunggah'
                                                }}</span>
...
export default {
    ...
    setup(_, { emit }) {
        ...
        return { nama, penyelenggara, jpl, tahun_kegiatan, file, loading, handleSubmit, handleFileSelect, closeModal, errorMessage};
    },
}
</script>
